...
function getPrePurchaseItem(): ConfirmPurchaseItemType | null {
  const str = localStorage.getItem("prePurchaseItem");
  if (!str) return null;
  try {
    return JSON.parse(str) as ConfirmPurchaseItemType;
  } catch {
    return null;
  }
}
