...
export const sampleProducts: Product[] = [
  { id: 1, title: 'Classic Lamp', unitPrice: 29.99, description: 'A warm desk lamp', image: '',},
  { id: 2, title: 'Modern Chair', unitPrice: 129.99, description: 'Comfortable and stylish', image: '',},
  { id: 3, title: 'Coffee Mug', unitPrice: 9.99, description: 'Ceramic mug', image: ''},
]

export const sampleAvailableProducts: ModifiedProduct[] = [
